...
//移动端调试
var vcon = GetQueryString("vcon");
if(vcon == "1") {
    var vConsole = new VConsole();
}

//调用APP方法开关
 var appSwitch=false,hasSignup=false;
...
// if(!appSwitch&&!hasSignup)  testLogin();
var appSwitch = false;
var testAppNum=0;
var testAppSwitch=setInterval(function () {
    if( typeof(eval( app.toBorrowScheduleList))=="function"){
        appSwitch = true;
        console.log('appSwitch3:'+appSwitch)
        clearInterval(testAppSwitch)
    }else{
        appSwitch = false;
        console.log('appSwitch4:'+appSwitch)
    }
    testAppNum++;
    if(testAppNum==5) clearInterval(testAppSwitch)
},1000);
...
//     if(arrUrl[arrUrl.length-1]!='signup.html'){
//         var idCard = getCookie('idCard') || GetQueryString('idCard');
//         var phone = getCookie('phone') || GetQueryString('phone');
//         if (!idCard) window.location = 'signup.html?redirectURL='+strUrl;
//         var data = {
//             'idCard': idCard,
//         }
...
//                         /*window.location = 'signup.html?redirectURL='+strUrl;*/
//                     }
//                 }else{
//                    /* window.location = 'signup.html?redirectURL='+strUrl;*/
//                 }
