var gallery = '';
    gallery += '<div id="gallery" class="pswp" tabindex="-1" role="dialog" aria-hidden="true">';
    ...
    gallery += '</div>';
    gallery += '</div>';
$(gallery).appendTo(document.body);
...
(function() {
        ...
        var parseThumbnailElements = function(el) {
            ...
            for(var i = 0; i < numNodes; i++) {
                ...
                item = {
                    ...
                    w: parseInt(childElements[0].naturalWidth, 10),
                    h: parseInt(childElements[0].naturalHeight, 10),
                    author: el.getAttribute('data-author')
                };
    ...
    //console.log($('.demo-gallery').length);
})();