...
public class XXTeaUtil {
	...
	public static void main(String[] args) {
		String p2 = "{\"reqParam\":{\"cmCellphone\":\"13482772194\",\"cmPassword\":\"111111\",\"deviceId\":\"adminadminadmin\"},\"reqHeadParam\":{},\"sn\":\"110\"}";
		String afterEncrypt = xxteaEncrypt(p2, "123456");
		System.out.println(afterEncrypt);
		String afterDecrypt = xxteaDecrypt(afterEncrypt, "123456");
